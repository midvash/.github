...
**Plataforma bíblica gratuita, mantida por anúncios — leia, busque, estude e construa.**

🌐 **[midvash.com](https://midvash.com)** — o leitor · 🔌 **[api.midvash.com](https://api.midvash.com)** — a API pública

---

## O que construímos

A Midvash é uma plataforma bíblica completa: 86 traduções em 32 idiomas
servidas por uma API pública gratuita, um leitor web caprichado em 9 idiomas
de interface com busca em texto completo, estudo assistido por IA, leituras
diárias, referências cruzadas, perfis de personagens bíblicos, comentários
e um dicionário de teologia bíblica. Gratuito para usar, mantido por anúncios.
...
| Repo | O quê |
|------|------|
| **[bible-api](https://github.com/midvash/bible-api)** | API bíblica pública, gratuita e sem chave — versículos, capítulos e versões em 86 traduções bíblicas. Move a api.midvash.com. |
| **[bible-mcp](https://github.com/midvash/bible-mcp)** | Servidor MCP gratuito e sem chave para a API bíblica pública — Escrituras para LLMs a partir de qualquer cliente MCP. Move a mcp.midvash.com. |
| **[bible-data](https://github.com/midvash/bible-data)** | 33 versões bíblicas de domínio público em 22 idiomas, JSON + SQLite, codificadas em OSIS. O conjunto de dados que move nosso leitor. |
...
*(A própria API serve conteúdo bíblico em 32 idiomas — estes 9 são os
idiomas para os quais a interface do leitor está totalmente traduzida.)*

## Fale com a gente

- **Use o leitor**: [midvash.com](https://midvash.com)
- **Construa com a API**: [api.midvash.com](https://api.midvash.com)
- **Reporte um problema de conteúdo**: [midvash.com/feedback](https://midvash.com/feedback)
- **E-mail**: contact@midvash.com
